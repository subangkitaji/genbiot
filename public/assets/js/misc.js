    ...
    $(function() {
        ...
        function applyStyles() {
            ...
            if (
                ...
                setTimeout(function() {
                    if (
                        ...
                        sidebar.outerHeight() - footer.outerHeight()
                    ) {
                        contentWrapper.css({
                            "min-height":
                                sidebar.outerHeight() - footer.outerHeight()
                    ...
                    if (
                        sidebar.outerHeight() <
                        contentWrapper.outerHeight() + footer.outerHeight()
                    ) {
                        sidebar.css({
                            "min-height":
                                contentWrapper.outerHeight() +
            ...
            if (!body.hasClass("rtl")) {
                $(
                    ".settings-panel .tab-content .tab-pane.scroll-wrapper, ul.chats, .product-chart-wrapper"
                ).perfectScrollbar();
